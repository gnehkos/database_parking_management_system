<x-layout title="Dashboard">
    ...
    <div class="page-header">
        ...
        <div class="page-sub">Here's what's happening at the parking facility today.</div>
    </div>
    ...
    <div class="row g-3 mb-4">
        @foreach ([
            ...
            ["Today's Revenue", '$'.number_format($todayRevenue,2), $todayTransactions.' transactions', 'bi-banknote', '#ff9500'],
        ...
        <div class="col-md-8">
            <div class="card-ios card-ios-p">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="island"><span class="dot dot-green"></span> {{ $activeTickets }} Active</div>
                </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-md-8">
            <div class="card-ios card-ios-p">
                ...
                @empty
                    <div class="text-center py-4" style="color:var(--gray)">No active vehicles today.</div>
                @endforelse
            </div>
        </div>
    </div>
